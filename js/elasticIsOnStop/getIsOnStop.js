...
function getIsOnStop(ROUTE_NUMBER,time){
    ...
    es_stream.on("end", async function () {
        ...
        fs.writeFileSync(`./Data/Elastic_query/getIsOnStop/${ROUTE_NUMBER}.json`, JSON.stringify(obj2));
    })
...
getIsOnStop(701402,{week, day, hours, minutes, sec})